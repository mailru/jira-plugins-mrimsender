...
public class ReminderGenerator {
  private static final String[] REMINDER_TEMPLATES = {
    ...
    "Напоминаю, что у есть задача ([TASK_KEY]) в JIRA. Если ты ничего не сделаешь, я начну говорить, что ты не работаешь. (шучу) 😏",
    ...
    "Эй ты, напоминаю, что есть задача в JIRA ([TASK_KEY]). Что ж, давай-давай, давай-давай, у нас же всего так мало времени на все про все. 🙄",
    ...
    "Эй, ты, задача в JIRA ([TASK_KEY]) ждет своего героя! Неужели ты собираешься ее проигнорировать? Я знаю, ты этого не сделаешь. 😉",
  ...
  private static final String[] ADDITIONAL_MESSAGES = {
    ...
    "Если мы не сможем закончить эту задачу, нас призовут в Аваду Кедавру. 🧙‍♀️ #HarryPotter",
