...
links.Timeline.ItemBox.prototype.updateDOM = function () {
    ...
    if (divBox) {
        ...
        // update class
        divBox.className = "timeline-event timeline-event-box timeline-ui-widget timeline-ui-state-default";// ui-widget -> timeline-ui-widget, ui-state-default -> timeline-ui-state-default
        divLine.className = "timeline-event timeline-event-line timeline-ui-widget timeline-ui-state-default";
        divDot.className  = "timeline-event timeline-event-dot timeline-ui-widget timeline-ui-state-default";

        if (this.isCluster) {
            links.Timeline.addClassName(divBox, 'timeline-event-cluster timeline-ui-widget-header'); // ui-widget-header -> timeline-ui-widget-header
            links.Timeline.addClassName(divLine, 'timeline-event-cluster timeline-ui-widget-header');
            links.Timeline.addClassName(divDot, 'timeline-event-cluster timeline-ui-widget-header');
        }
        ...
        if(this.className) {
            divBox.style['background'] = this.className;
            divBox.style['background-color'] = this.className;
            divBox.style['border-color'] = this.className;
            divLine.style['background'] = this.className;
            divLine.style['background-color'] = this.className;
            divLine.style['border-color'] = this.className;
            divDot.style['background'] = this.className;
            divDot.style['background-color'] = this.className;
            divDot.style['border-color'] = this.className;
        }
...
links.Timeline.ItemRange.prototype.updateDOM = function () {
    ...
    if (divBox) {
        ...
        // Start Custom Modification
        // update class
        divBox.className = "timeline-event timeline-event-range timeline-ui-widget timeline-ui-state-default";

        if (this.isCluster) {
            links.Timeline.addClassName(divBox, 'timeline-event-cluster timeline-ui-widget-header');
        }
