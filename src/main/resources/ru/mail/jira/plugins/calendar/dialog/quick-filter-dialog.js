define(
    ...
    ['jquery', 'underscore', 'backbone', 'aui/dialog2', 'calendar/jql-auto-complete-utils'],
    function($, _, Backbone, dialog2, CalendarJQLAutoComplete) {
        return Backbone.View.extend({
            ...
            initialize: function(options) {
                ...
                this.render();
                this.dialog = dialog2('#mailrucalendar-quick-filter-dialog');
