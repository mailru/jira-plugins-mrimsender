define('calendar/non-working-day-configuration-dialog', ['jquery', 'underscore', 'backbone'], function($, _, Backbone) {
    return Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.dialog = AJS.dialog2('#calendar-non-working-day-configuration-dialog');
