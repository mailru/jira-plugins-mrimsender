...
import {deleteSubscription, getCurrentUserSubscriptions} from "./api/SubscriptionsApiClient";
...
export const useSubscriptionDelete = (): UseMutationResult<undefined, AxiosError, number> =>
