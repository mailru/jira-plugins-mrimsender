...
export const loadChatIssueCreationSettings = async (
  ...
  return axios.get(
    `${contextPath()}/rest/myteam/1.0/issueCreation/settings/chats/${chatId}`,
  );
};

export const loadChatIssueCreationSettingsById = async (
  id: number,
): Promise<AxiosResponse<IssueCreationSettings>> => {
  return axios.get(
    `${contextPath()}/rest/myteam/1.0/issueCreation/settings/${id}`,
  );
};
...
export const createChatIssueCreationSettings = async (
  ...
  return axios.post(
    `${contextPath()}/rest/myteam/1.0/issueCreation/settings`,
    settings,
  );
};
...
export const deleteChatIssueCreationSettings = async (
  id: number,
): Promise<AxiosResponse<IssueCreationSettings>> => {
  return axios.delete(
    `${contextPath()}/rest/myteam/1.0/issueCreation/settings/${id}`,
...
export const loadProjectChatIssueCreationSettings = async (
  ...
  return axios.get(
    `${contextPath()}/rest/myteam/1.0/issueCreation/settings/projects/${projectKey}`,
  );
};
